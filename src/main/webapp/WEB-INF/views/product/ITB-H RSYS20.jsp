...
<html lang="en">
    <head>
        ...
        <title>ITB-H RSYS20 수소개질장치 - MDR Co., Ltd.</title>
        </c:if>
        <c:if test="${language == 'en'}">
        <title>ITB-H RSYS20 Hydrogen Reformer - MDR Co., Ltd.</title>
        </c:if>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="single-content wow fadeInUp">
                                    <c:if test="${language == 'ko'}">
                             <img src="resources/img/제품4-1.jpg" />
                             </c:if>
                             <c:if test="${language == 'ko'}">
                             
                             <img src="resources/img/제품e4.jpg" />
                             </c:if>
